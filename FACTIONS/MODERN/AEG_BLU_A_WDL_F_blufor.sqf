...
///////////////
///////////////   "BLU_A_WDL_F", "Aegis British - 2035 (Woodland)", "AEG_BLU_A_WDL_F"
///////////////
...
blufor_SOLDIER_X =				"B_A_Soldier_WDL_F";					//patrol, fortify, paradrop
blufor_SOLDIER_LAT_X =			"B_A_Soldier_LAT_WDL_F";				//initHQ\fnc_HQguards, supports\fnc_paradrop
blufor_SOLDIER_GL_X =			"B_A_Soldier_GL_WDL_F";				//initHQ\fnc_HQguards, supports\fnc_paradrop
blufor_SOLDIER_TL_X =			"B_A_Soldier_TL_WDL_F";				//initHQ\fnc_createpatrolFOB, initHQ\fnc_HQguards
blufor_SOLDIER_SL_X =			"B_A_Soldier_SL_WDL_F";				//Comms voice, Multiplayer slot
blufor_SOLDIER_AR_X =			"B_A_Soldier_AR_WDL_F";				//supports\fnc_paradrop, initHQ\fnc_HQguards
blufor_MARKSMAN_X = 			"B_A_soldier_M_WDL_F";				//initHQ\fnc_HQguards
blufor_OFFICER_X =				"B_A_OFFICER_WDL_F";					//initHQ\fnc_BluHQinit
blufor_HELI_PILOT_X	=			"B_A_Helipilot_WDL_F";				//Rescue Pilot mission
...
blufor_CAR_PATROL1_X =			"B_A_LSV_01_armed_WDL_F";					//random patrol
blufor_APC_PATROL1_X =			"B_A_MRAP_03_HMG_WDL_F";					//random patrol
blufor_APC_PATROL2_X =			"B_A_APC_tracked_03_cannon_v2_wdl_F";		//random patrol
blufor_TANK_PATROL1_X =			"B_W_MBT_01_cannon_F";						//random patrol
...
blufor_TURRET_AA = 				"B_A_static_AA_WDL_F";
blufor_TURRET_AT =				"B_A_static_AT_WDL_F";
blufor_TURRET_HMG =				"B_A_HMG_02_high_WDL_F";
blufor_TURRET_GMG =				"B_A_GMG_01_high_WDL_F";
...
blufor_SPECOPS_X =				"B_A_recon_WDL_F";					//operator
blufor_SPECOPS_GL_X =			"B_A_recon_JTAC_WDL_F";				//operator
blufor_SPECOPS_LAT_X =			"B_A_recon_LAT_WDL_F";				//operator
blufor_SPECOPS_HAT_X =			"B_A_Soldier_AT_WDL_F";		//operator
blufor_SPECOPS_AA_X =			"B_A_soldier_AA_WDL_F";				//operator
blufor_SPECOPS_MG_X =			"B_A_Recon_MG_WDL_F";		//operator
blufor_SPECOPS_MEDIC_X =		"B_A_recon_medic_WDL_F";				//operator
blufor_SPECOPS_MARK_X =			"B_A_recon_M_WDL_F";					//operator
blufor_SPECOPS_SNIPER_X =		"B_A_Recon_Sharpshooter_WDL_F";					//operator
blufor_SPECOPS_EXP_X =			"B_A_recon_exp_WDL_F";				//operator
blufor_SPECOPS_ENG_X = 			"B_A_Engineer_WDL_F";			//operator
...
blufor_RQST_UNIT_01_X = 			["B_A_Soldier_WDL_F","Rifleman (2CP)",2];
blufor_RQST_UNIT_02_X =				["B_A_Soldier_GL_WDL_F","Grenadier (3CP)",3];
blufor_RQST_UNIT_03_X =				["B_A_Soldier_AR_WDL_F","Automatic Rifleman (3CP)",3];
blufor_RQST_UNIT_04_X =				["B_A_HeavyGunner_WDL_F","Heavy Gunner (4CP)",4];
blufor_RQST_UNIT_05_X =				["B_A_Medic_WDL_F","Medic (4CP)",4];
blufor_RQST_UNIT_06_X =				["B_A_Soldier_LAT_WDL_F","AT Rifleman (3CP)",3];
blufor_RQST_UNIT_07_X =				["B_A_Soldier_AT_WDL_F","AT Specialist (4CP)",4];
blufor_RQST_UNIT_08_X =				["B_A_soldier_AA_WDL_F","AA Specialist (4CP)",4];
blufor_RQST_UNIT_09_X =				["B_A_Engineer_WDL_F","Engineer (4CP)",4];
blufor_RQST_UNIT_10_X =				["B_A_soldier_M_WDL_F","Marksman (3CP)",3];
blufor_RQST_UNIT_11_X =				["B_A_sniper_WDL_F","Sniper (4CP)",4];
...
blufor_RQST_VEHICLE_03_X =			["B_A_APC_TRACKED_03_CANNON_v2_WDL_F","Lancer APC (30CP)",30];
blufor_RQST_VEHICLE_04_X =			["B_A_MRAP_03_WDL_F","Strider Unarmed (5CP)",5];
blufor_RQST_VEHICLE_05_X =			["B_A_MRAP_03_hmg_WDL_F","Strider HMG (18CP)",18];
blufor_RQST_VEHICLE_06_X =			["B_A_MRAP_03_gmg_WDL_F","Strider GMG (25CP)",25];
blufor_RQST_VEHICLE_07_X =			["B_LSV_01_unarmed_WDL_F","Prowler Unarmed (5CP)",5];
blufor_RQST_VEHICLE_08_X =			["B_LSV_01_armed_WDL_F","Prowler HMG (15CP)",15];
blufor_RQST_VEHICLE_09_X =			["B_LSV_01_WDL_AT_F","Prowler AT (20CP)",20];
