...
fnc_call_ui_resource = compile preprocessFileLineNumbers "functions\misc\fnc_call_ui_resource.sqf";publicVariable "fnc_call_ui_resource.sqf";
fnc_set_insignia = compile preprocessFileLineNumbers "functions\misc\fnc_set_insignia.sqf";publicVariable "fnc_set_insignia.sqf";
